/-
# Positive Definite Integral: Mercer-Type Kernels

Mercer-type positive-definite kernels (no group structure required) and
algebraic building blocks (conj_symm, one, mul, smul, finprod, comp).
-/

import YangMills.Proofs.PositiveDefiniteIntegral.IntegralOperator
